    ...
    return GlassCard(
      ...
      child: Theme(
        ...
        child: Material(
          color: const Color(
            0x01000000,
          ), // Fixes "ListTile background color or ink splashes may be invisible" error
          child: ExpansionTile(
            ...
            children: [
              ...
              if (widget.optimizationTips != null &&
                  widget.optimizationTips!.isNotEmpty) ...[
                gapH16,
                Container(
