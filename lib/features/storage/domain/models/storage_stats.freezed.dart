...
mixin _$StorageStats {
 ...
 int get totalSpace; int get freeSpace; int get usedSpace; double get usagePercentage; double get readSpeed; double get writeSpeed;
...
@useResult
$Res call({
 int totalSpace, int freeSpace, int usedSpace, double usagePercentage, double readSpeed, double writeSpeed
});
...
/// Create a copy of StorageStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalSpace = null,Object? freeSpace = null,Object? usedSpace = null,Object? usagePercentage = null,Object? readSpeed = null,Object? writeSpeed = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalSpace,  int freeSpace,  int usedSpace,  double usagePercentage,  double readSpeed,  double writeSpeed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StorageStats() when $default != null:
return $default(_that.totalSpace,_that.freeSpace,_that.usedSpace,_that.usagePercentage,_that.readSpeed,_that.writeSpeed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalSpace,  int freeSpace,  int usedSpace,  double usagePercentage,  double readSpeed,  double writeSpeed)  $default,) {final _that = this;
switch (_that) {
case _StorageStats():
return $default(_that.totalSpace,_that.freeSpace,_that.usedSpace,_that.usagePercentage,_that.readSpeed,_that.writeSpeed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalSpace,  int freeSpace,  int usedSpace,  double usagePercentage,  double readSpeed,  double writeSpeed)?  $default,) {final _that = this;
switch (_that) {
case _StorageStats() when $default != null:
return $default(_that.totalSpace,_that.freeSpace,_that.usedSpace,_that.usagePercentage,_that.readSpeed,_that.writeSpeed);case _:
  return null;
...
class _StorageStats implements StorageStats {
  const _StorageStats({this.totalSpace = 0, this.freeSpace = 0, this.usedSpace = 0, this.usagePercentage = 0.0, this.readSpeed = 0.0, this.writeSpeed = 0.0});
...
/// Create a copy of StorageStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalSpace = null,Object? freeSpace = null,Object? usedSpace = null,Object? usagePercentage = null,Object? readSpeed = null,Object? writeSpeed = null,}) {
